...
tags: ['webpack', 'rollup', 'npm']
draft: false
summary: 使用webpack和rollup打包React组件库并发布到npm
---
...
![包体的大小](/static/使用webpack和rollup打包React组件库/image-20210224001139792.png)
...
![npm打包输出](/static/使用webpack和rollup打包React组件库/image-20210224215214179.png)
