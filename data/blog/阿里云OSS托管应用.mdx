...
![使用变量和密码](/static/ali-oss/使用变量和密码.png)

之后在使用`npm install`等命令下载各种包和工具，打包生成静态文件就OK了。

![工作流程](/static/ali-oss/工作流程.png)
...
![使用ossutil上传文件](/static/ali-oss/oss-util上传文件.png)
