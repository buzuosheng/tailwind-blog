...
![代码样式对照](/static/tailwindcss-弟弟们都往后稍稍/image-20210321141816894.png)

![颜色对比](/static/tailwindcss-弟弟们都往后稍稍/image-20210321141934145  .png)

- **按需配置打包**。在生产环境，tailwindcss会自动删除所有未使用的css，尽可能的使css代码更小。

![css代码压缩](/static/tailwindcss-弟弟们都往后稍稍/image-20210321193429531.png)
...
![font-size](/static/tailwindcss-弟弟们都往后稍稍/image-20210321225417361.png)
